...
> [!TIP]
> 此教程以Voron 2.4为例介绍接线方法，请结合自己的实际使用情况接线

## 3.1 九轴接口图

<img src="../../images/boards/fly_9/interface.jpg" alt="interface" style="zoom:80%;" />

## 3.1 电源接线

<img src="../../images/boards/fly_9/power.jpg" alt="power" style="zoom:70%;" />
...
<img src="../../images/boards/fly_9/driver.jpg" alt="driver" style="zoom:80%;" />
...
<img src="../../images/boards/fly_9/2209.jpg" alt="2209" style="zoom:80%;" />
...
<img src="../../images/boards/fly_9/motor.jpg" alt="motor" style="zoom:80%;" />

## 3.3  加热棒接线

<img src="../../images/boards/fly_9/heat.jpg" alt="heat" style="zoom:67%;" />
...
<img src="../../images/boards/fly_9/acbed.jpg" alt="acbed" style="zoom:80%;" />

**直流热床：**板载MOS接直流热床时请注意使用功率，直流热床最大电流不能超过10A。如果超过10A，建议使用外接MOS模块来使用热床，否则可能会对主板造成不可逆的损伤。

<img src="../../images/boards/fly_9/dcbed.jpg" alt="dcbed" style="zoom:80%;" />
...
![nozzle_th](../../images/boards/fly_9/nozzle_th.jpg)

**热床热敏：**

![bed_th](../../images/boards/fly_9/bed_th.jpg)

## 3.6 风扇接线

风扇电压与主板供电电压相同

<img src="../../images/boards/fly_9/fan.jpg" alt="fan" style="zoom:80%;" />

## 3.7  限位开关接线

限位开关有常开（NO）和常闭（NC）两种。一般在3D打印机上，建议使用**常闭（NC）**，这样在限位开关线路出现问题时，系统会及时报错，可以避免一些不必要的撞车，避免损坏打印机。

<img src="../../images/boards/fly_9/endstop.jpg" alt="endstop" style="zoom:70%;" />
...
<img src="../../images/boards/fly_9/pl08.jpg" alt="pl08" style="zoom:67%;" />

### 3.8.2 BL-Touch接线

BL-touch一共有五根线，三根为第一组，负责传感器的供电和探针的收放，第二组为地线和信号线，输出限位信号。BL-touch接线时请仔细核对线序，错误的接线可能会永久性损坏传感器和主板！！！接线方法如下图所示。

<img src="../../images/boards/fly_9/bltouch.jpg" alt="bltouch" style="zoom:67%;" />
...
<img src="../../images/boards/fly_9/klicky.jpg" alt="klicky" style="zoom:67%;" />
...
<img src="../../images/boards/fly_9/tap.jpg" alt="tap" style="zoom:67%;" />
...
![toπ](../../images/boards/fly_9/toπ.jpg)
