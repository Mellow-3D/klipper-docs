...
![power](../../images/boards/fly_d7/power.png)
...
<img src="../../images/boards/fly_d7/motor.png" alt="motor" style="zoom:80%;" />

## 5.4  加热棒接线

<img src="../../images/boards/fly_d7/heater.png" alt="heater" style="zoom:80%;" />
...
<img src="../../images/boards/fly_d7/ACbed.png" alt="ACbed" style="zoom:65%;" />

**直流热床：**板载MOS接直流热床时请注意使用功率，直流热床最大电流不能超过10A。如果超过10A，建议使用外接MOS模块来使用热床，否则可能会对主板造成不可逆的损伤。

<img src="../../images/boards/fly_d7/DCbed.png" alt="DCbed" style="zoom:65%;" />
...
<img src="../../images/boards/fly_d7/thermmistor.png" alt="thermmistor" style="zoom:80%;" />
...
<img src="../../images/boards/fly_d7/fan.png" alt="fan" style="zoom:80%;" />

## 5.8  限位开关接线

限位开关有常开（NO）和常闭（NC）两种。一般在3D打印机上，建议使用**常闭（NC）**，这样在限位开关线路出现问题时，系统会及时报错，可以避免一些不必要的撞车，避免损坏打印机。

<img src="../../images/boards/fly_d7/endstop.png" alt="endstop" style="zoom:80%;" />
...
<img src="../../images/boards/fly_d7/pl08.png" alt="pl08" style="zoom:80%;" />

### 5.9.2 BL-Touch接线

BL-touch一共有五根线，三根为第一组，负责传感器的供电和探针的收放，第二组为地线和信号线，输出限位信号。BL-touch接线时请仔细核对线序，错误的接线可能会永久性损坏传感器和主板！！！接线方法如下图所示。

<img src="../../images/boards/fly_d7/bltouch.png" alt="bltouch" style="zoom:80%;" />
...
<img src="../../images/boards/fly_d7/klicky.png" alt="klicky" style="zoom:80%;" />
...
<img src="../../images/boards/fly_d7/tap.png" alt="tap" style="zoom:60%;" />
...
<img src="../../images/boards/fly_d7/mini12864.png" alt="mini12864" style="zoom:80%;" />

## 5.11 连接到上位机

主板通过TypeC接口连接到上位机的USB口，也可以用过串口连接到上位机。这里只对前者做介绍。

<img src="../../images/boards/fly_d7/toπ.png" alt="toπ" style="zoom:80%;" />
