...
# 	 Notes
#####################################################################
## 请将[include SB2040V3.cfg]添加到printer.cfg下
## Please add [include SB2040V3.cfg] under printer.cfg
...
[extruder]
step_pin:SB2040V3:gpio14
dir_pin:SB2040V3:gpio13
enable_pin: !SB2040V3:gpio16
