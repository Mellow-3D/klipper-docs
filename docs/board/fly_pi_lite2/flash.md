...
4. 点击**“Select target**”选择SD卡，大小和SD卡容量差不多的就是，或进入资源管理器查看SD卡盘符
   ...
   ![2](../../images/boards/fly_pi/etcher2.png)
   ...
   6. 如果写入失败或者需要重新刷写镜像时，请按如下操作：
      ...
      <img src="../../images/boards/fly_pi/format2.png" alt="格式化1" style="zoom: 80%;" />
      ...
      <img src="../../images/boards/fly_pi/format4.png" alt="格式化1" style="zoom:80%;" />

   7. 至此已经完成FLY镜像的写入，但是请勿拔出内存卡，还需要修改boot盘中的NetWork文件，具体修改方法请查看：[FLY_Config](/board/fly_pi_lite2/config "点击即可跳转")
